                ...
                $.ajax(
                    {
                        ...
                        async: false,
                        data: {
                            'Title': Title, 'RoleIds': RoleIds, 'PermissionType': PermissionType, 'PermissionCode': PermissionCode, 'PermissionAccsessType': PermissionAccsessType,
                        },
                        success: function (response) {
                            var messageClass = '';
                            if (response.Status == true) {
                                document.getElementById("frm-addPermission").reset();
