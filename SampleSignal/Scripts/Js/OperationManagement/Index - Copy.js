...
var Budget = {
    ...
    GetBudgetList: function () {
            ...
            columns: [
                ...
                //},
                {
                    command: [
                        ...
                        { name: "secondCustom", text: "<span class='customIcon iconInfo'>مدیریت عملکرد</span>", click: assignProductToGoals },
        ...
        function assignProductToGoals(e) {
            ...
            e.stopPropagation();
            var dataItemBudget = this.dataItem($(e.currentTarget).closest("tr"));
            var budgetchId = dataItemBudget.Id;
            var MenuId = 'OperationManagement';
            var TabUrl = '/Budget/AssignProductToGoalInBudget?budgetId=' + budgetchId;
            var TabScriptAddress = '/Scripts/Js/Budget/AssignProductToGoalInBudget.js';
            CustomTab.LinkToAnOtherPage(MenuId, TabUrl, TabScriptAddress);
        }
