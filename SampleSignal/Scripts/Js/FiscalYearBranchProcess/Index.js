...
var FiscalYearBranchProcess = {
    ...
    AddListener: function () {
      ...
      8              
                        ...
                        var BranchNotAssignedListGrid = $("#ProcessNotAssignedListGrid").data("kendoGrid");
                        BranchNotAssignedListGrid.dataSource.transport.options.read.url = '/FiscalYearBranchProcess/GetNotAdded/' + $("#YearId").val();
                        BranchNotAssignedListGrid.dataSource.read();

                        var BranchAssignedListGrid = $("#ProcessAssignedListGrid").data("kendoGrid");
                        BranchAssignedListGrid.dataSource.transport.options.read.url = '/FiscalYearBranchProcess/GetAdded/' + $("#YearId").val();
    ...
    GetAllProcessForAssigningToYear: function () {
        ...
        $("#ProcessNotAssignedListGrid").empty();
        debugger;
        ...
        function onChange(arg) {
            ...
            if (selectedProcessIds.length > 0) {
                $('#AssignProcessToYear1').removeClass('displayNone').addClass('displayShow');
            } else {
                $('#AssignProcessToYear1').removeClass('displayShow').addClass('displayNone');
            }
        }
    },
    ...
    GetAllProcessAssignedToYear: function () {
       ...
       // شعبه
        function SetBranchAssigned(e) {
            ...
            var MenuId = 'FiscalYearBranchProcess';
            var TabUrl = '/FiscalYearBranchProcess/BranchProcess?YearId=' + YearId + "&ProcessActivityAccountStructureId=" + dataItemProcess.ProcessActivityAccountStructureId + '&TypeYear=' + $('#TypeYear').val();
            var TabScriptAddress = '/Scripts/Js/FiscalYearBranchProcess/BranchProcess.js';
